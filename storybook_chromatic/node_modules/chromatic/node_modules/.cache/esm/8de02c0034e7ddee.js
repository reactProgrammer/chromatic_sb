let bailFile;_34e‍.x([["getDependentStoryFiles",()=>getDependentStoryFiles]]);_34e‍.w("../ui/messages/warnings/bailFile",[["default",["bailFile"],function(v){bailFile=v}]]);
...
const isUserCode = ({ name, moduleName }) => !EXTERNALS.some((re) => re.test(name || moduleName));
       ...
       function getDependentStoryFiles(ctx, stats, changedFiles) {
